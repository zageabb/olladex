...
- Query-ranked repository excerpts automatically supplied to Ollama instead of sending the whole codebase.
...
- Git push, pull, remotes and credential management are intentionally not exposed yet.
- Ranked context is lexical and symbol-aware; embedding-based semantic retrieval remains future work.
- Session summaries are deterministic and local rather than generated by a second model call.

## Next release direction

v0.4 should focus on a packaged desktop shell, embedding-assisted retrieval, richer terminal emulation, Git remotes with explicit approval, and stronger end-to-end agent reliability.
